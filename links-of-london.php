    ...
    <body class="work teal">
        ...
        <div class="work-nav">
            <ul class="work-nav__list">
                ...
                <li class="work-nav__item">
                    <a href="follifollie" class="work-nav__link work-nav__link--next">
                        ...
                        <div class="section-header__header">
                            <div class="section-header__details">
                                ...
                                <ul class="section-header__list">
                                    ...
                                    <li class="section-header__item">Photoshop</li>
                             ...
                             <div class="section-header__intro">
                                <p>British jewellery brand Links of London approached me to be a consultant to improve the usability of their website and to increase their conversion rates.</p>
